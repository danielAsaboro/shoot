...
export function WorldCupGoldenTrade({
  trade,
}: {
  trade: GoldenTrade;
}) {
    ...
    >
      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-sm font-bold text-white" style={{ fontFamily: "var(--font-sans)" }}>{trade.alias}</p>
            <div className="mt-1 flex items-center gap-2">
              ...
              <span className="text-xs text-white/50" style={{ fontFamily: "var(--font-sans)" }}>{trade.market}</span>
          ...
          <div className="text-right">
            <p className="text-xl font-bold" style={{ fontFamily: "var(--font-mono)", color: "#BFFF00" }}>
              ${trade.pnlUsd.toLocaleString()}
            </p>
            <p className="text-xs font-bold" style={{ fontFamily: "var(--font-mono)", color: "#00FF87" }}>
      ...
      <p className="mt-2 text-[10px] text-white/30 text-center" style={{ fontFamily: "var(--font-mono)" }}>
        {trade.matchContext}
      </p>
    </div>
  );
