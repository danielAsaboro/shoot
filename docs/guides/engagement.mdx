...
<Tabs>
  <Tab title="Phase 1 (Core)">
    ...
    | Mutagen + raffle ticket |
  </Tab>
  <Tab title="Phase 2 (Intermediate)">
    | Quest | Trigger | Target | Reward | |---|---|---|---| | Volume Hunter |
    `volume_threshold` | Hit volume target 3x | Mutagen + raffle tickets | |
    Specialist Explorer | `specialist_track_completed` | Complete 3 specialist
    tracks | Mutagen + raffle tickets | | Iron Discipline |
    `challenge_pass_elite_disciplined` | Pass Elite with low DD | Mutagen +
    raffle tickets |
  </Tab>
  <Tab title="Phase 3 (Advanced)">
    | Quest | Trigger | Target | Reward | |---|---|---|---| | World Cup
    Qualifier | `worldcup_qualify` | Qualify for WC | Mutagen + raffle tickets |
    | Globetrotter | `worldcup_all_divisions` | Compete in all 4 divisions |
    Mutagen + raffle tickets |
  </Tab>
</Tabs>
