...
- **Solana** (devnet) for on-chain entry fees and settlement via the Shoot Anchor program
...
│  /api/adrena-live/*  → Real Adrena data passthrough        │
└────────────────┬────────────────────────────────────────────┘
                 │
    ┌────────────┴─────────────────┐
    │  Adrena Live Adapter         │
    │  datapi.adrena.trade         │
    │  → real positions + metrics  │
    └──────────────────────────────┘
```
